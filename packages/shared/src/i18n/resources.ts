  ...
  "translation": {
    ...
    "nodes": {
      ...
      "memory": {
        ...
        "bulkDescription": "Writes the same setting to the selected nodes.",
        ...
        "keepInterval": "Each node keeps its current sampling interval.",
